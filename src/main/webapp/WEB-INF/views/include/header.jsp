            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">회원이름</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="#" class="btn btn-default btn-flat">시험현황</a>
                    </div>
                    <div class="pull-right">
                      <a href="${pageContext.request.contextPath}/member/login" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
...
<!--             <li class="treeview">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="test"><a href="#"><i class="fa fa-circle-o"></i>정보처리기사</a>
                <!-- 	<ul class="treeview-menu">
                		<li><a href="../UI/icons.html"><i class="fa fa-circle-o"></i>2019-3</a></li>
                	</ul> -->
                </li>
                <li class="test"><a href="#"><i class="fa fa-circle-o"></i>리눅스마스터2급</a></li>
              </ul>
            </li>
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="#"><i class="fa fa-circle-o"></i> General Elements</a></li>
